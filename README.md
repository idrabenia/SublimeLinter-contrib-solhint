...
2. When the plugin list appears, type `solhint`. Among the entries you should see `SublimeLinter-solhint`. If that entry is not highlighted, use the keyboard or mouse to select it.
